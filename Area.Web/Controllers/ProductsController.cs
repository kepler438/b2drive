...
namespace Area.Web.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create([Bind(Include = "ID,SubCategoryID,Name,CreateDate,IsActive")] Product product)
        {
        ...
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        public ActionResult Edit([Bind(Include = "ID,SubCategoryID,Name,IsActive")] Product product)
        {
            if (ModelState.IsValid)
            {
                product.CreateDate = DateTime.Now;
